    ...
    <div className="bg-white rounded-lg shadow-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto">
      ...
      <div id="combined-bill-content" className="p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Combined Bill</h1>
          <p className="text-gray-600 mt-2">Complete Medical Billing Summary</p>
        </div>
        ...
        <div className="border-b pb-6 mb-6">
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="text-right">
              ...
              <p className="text-sm">Bill No: COMB-{patient.patient_id}-{new Date().getTime()}</p>
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p><span className="font-medium">Total Visits:</span> {patient.visitCount || 0}</p>
              <p><span className="font-medium">Department Status:</span> {patient.departmentStatus || 'OPD'}</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center text-sm text-gray-600 mt-8">
          <p>This is a combined bill for all medical services</p>
